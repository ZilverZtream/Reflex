 ...
 *
 * This module is NOT bundled with the core Reflex library to reduce bundle size.
 * Only load this if you need CSP-safe mode (no new Function / eval).
 *
 * Usage:
 *   import { SafeExprParser } from './SafeExprParser.js';
 *   const app = new Reflex().configure({ cspSafe: true, parser: new SafeExprParser() });
 */

const M = Symbol.for("rx.m");
...
if (typeof module !== "undefined") {
  module.exports = { SafeExprParser };
} else {
  window.SafeExprParser = SafeExprParser;
}
